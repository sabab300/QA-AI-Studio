...
class TestCaseRepository:
    ...
    # --------------------------------------------------
    # SHARED CORE ADDITION (ported from the Web port's
    # AI-Web/Core/test_case_repository.py): cross-scope listing.
    #
    # Every existing caller only ever lists test cases for ONE
    # already-selected Domain/Module/Knowledge Name. The Web
    # "Automation Workspace" landing page needed a real cross-scope
    # query instead of requiring a scope to be picked first; kept
    # here too so both copies of this shared Core file stay
    # consistent. Purely additive — does not change
    # list_test_cases()'s existing behavior or signature, and nothing
    # in the Desktop UI calls this yet.
    # --------------------------------------------------
    ...
    def list_distinct_scopes(self):
        ...
        currently have at least one test case.
        """
